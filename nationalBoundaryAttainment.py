...
for level in [75,76]:
    ...
    # subjects = {"Course Title":["English", "Mathematics","Graphic Communication","Practical Woodworking","Practical Metalworking","Design and Manufacture","Engineering Science"]}
    ...
    for index in range(len(data)):
        ...
        ax.scatter(subject["A Pass"],subject["A Boundary"],label=subject['Course'])
        ax.annotate(subject["Course"][0:5], (subject["A Pass"], subject["A Boundary"]),ha='left', rotation=60)
